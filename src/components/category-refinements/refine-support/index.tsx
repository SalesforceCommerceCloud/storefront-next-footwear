...
import type { RefinementProps } from '@/components/category-refinements/types';

/** Support type (`c_supportType`) multi-select facet: neutral / stability / motion_control. */
export default function RefineSupport({
    values,
    attributeId,
    isFilterSelected,
    toggleFilter,
